...
#sed -i -e 's/^PKG_BUILD_DEPENDS:=node$/PKG_BUILD_DEPENDS:=node\/host/' ./feeds/packages/lang/node-arduino-firmata/Makefile
#sed -i -e 's/^PKG_BUILD_DEPENDS:=node$/PKG_BUILD_DEPENDS:=node\/host/' ./feeds/packages/lang/node-cylon/Makefile
#sed -i -e 's/^PKG_BUILD_DEPENDS:=node$/PKG_BUILD_DEPENDS:=node\/host/' ./feeds/packages/lang/node-hid/Makefile
#sed -i -e 's/^PKG_BUILD_DEPENDS:=node$/PKG_BUILD_DEPENDS:=node\/host/' ./feeds/packages/lang/node-serialport/Makefile
